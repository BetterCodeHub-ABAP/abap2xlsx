...
*"* do not include other source files here!!!
  ...
  DATA print_gridlines TYPE zexcel_print_gridlines READ-ONLY VALUE abap_false. "#EC NOTEXT . " .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .
   ...
   DATA show_gridlines TYPE zexcel_show_gridlines READ-ONLY VALUE abap_true. "#EC NOTEXT .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .
    ...
    METHODS set_merge
      IMPORTING
        !ip_column_start TYPE simple DEFAULT zif_excel_common=>c_excel_sheet_min_col
        !ip_column_end   TYPE simple DEFAULT zif_excel_common=>c_excel_sheet_max_col
        !ip_row          TYPE zexcel_cell_row DEFAULT zif_excel_common=>c_excel_sheet_min_row
        !ip_row_to       TYPE zexcel_cell_row DEFAULT zif_excel_common=>c_excel_sheet_max_row
      RAISING
        zcx_excel .
...
CLASS zcl_excel_worksheet IMPLEMENTATION.
  ...
  METHOD add_new_column.
    ...
    lv_column_alpha = zcl_excel_common=>zif_excel_common~convert_column2alpha( ip_column ).
...
*--------------------------------------------------------------------*
    ...
    IF it_field_catalog IS NOT SUPPLIED.
      lt_field_catalog = zcl_excel_common=>zif_excel_common~get_fieldcatalog( ip_table = ip_table ).
    ELSE.
...
*--------------------------------------------------------------------*
    ...
    lv_column_int = zcl_excel_common=>zif_excel_common~convert_column2int( ls_settings-top_left_column ).
    ...
    ls_settings-bottom_right_column = zcl_excel_common=>zif_excel_common~convert_column2alpha( lv_maxcol ).
    ...
    WHILE lo_iterator->if_object_collection_iterator~has_next( ) EQ abap_true.
      ...
      IF  (    (  ls_settings-top_left_row     GE lo_curtable->settings-top_left_row                             AND ls_settings-top_left_row     LE lo_curtable->settings-bottom_right_row )
        ...
        AND
          (    (  lv_column_int GE zcl_excel_common=>zif_excel_common~convert_column2int( lo_curtable->settings-top_left_column ) AND lv_column_int LE zcl_excel_common=>zif_excel_common~convert_column2int( lo_curtable->settings-bottom_right_column ) )
            OR
               (  lv_maxcol     GE zcl_excel_common=>zif_excel_common~convert_column2int( lo_curtable->settings-top_left_column ) AND lv_maxcol     LE zcl_excel_common=>zif_excel_common~convert_column2int( lo_curtable->settings-bottom_right_column ) )
          ).
...
* It is better to loop column by column (only visible column)
    LOOP AT lt_field_catalog ASSIGNING <ls_field_catalog> WHERE dynpfld EQ abap_true.
      ...
      lv_column_alpha = zcl_excel_common=>zif_excel_common~convert_column2alpha( lv_column_int ).
...
*--------------------------------------------------------------------*
    ...
    LOOP AT me->tables->collection INTO lo_table_object.
      ...
      ld_table_top_left_column =
        zcl_excel_common=>zif_excel_common~convert_column2int(
    ...
    IF ld_style_guid IS NOT INITIAL.
      TRY.
          ...
          IF ls_stylemapping-complete_style-number_format-format_code =
            ...
            ld_date =
              zcl_excel_common=>zif_excel_common~excel_string_to_date( ld_cell_value ).
...
*--------------------------------------------------------------------*
    ...
    ELSE.
      lv_column = zcl_excel_common=>zif_excel_common~convert_column2int( ip_cell_column ).
...
* Now build sheetnumber.  Increase counter until we hit a number that is not used so far
  ...
  METHOD get_active_cell.
    ...
    lv_active_column = zcl_excel_common=>zif_excel_common~convert_column2alpha( active_cell-cell_column ).
  ...
  METHOD get_cell.
    ...
    lv_column = zcl_excel_common=>zif_excel_common~convert_column2int( ip_column ).
...
*    IF upper_cell-cell_coords = '0'.
  ...
  METHOD get_merge.
    ...
    LOOP AT me->mt_merged_cells ASSIGNING <ls_merged_cell>.
      ...
      lv_col_from = zcl_excel_common=>zif_excel_common~convert_column2alpha( <ls_merged_cell>-col_from ).
      lv_col_to   = zcl_excel_common=>zif_excel_common~convert_column2alpha( <ls_merged_cell>-col_to   ).
  ...
  METHOD get_row.
    ...
    WHILE lo_row_iterator->has_next( ) = abap_true.
      ...
      IF lo_row->zif_excel_row~get_row_index( ) = ip_row.
        eo_row = lo_row.
        EXIT.
      ENDIF.
    ENDWHILE.
...
*  CATCH zcx_excel.    "
  ...
  METHOD get_title.
    ...
    IF ip_escaped EQ abap_true.
      lv_value = me->title.
      ep_title = zcl_excel_common=>zif_excel_common~escape_string( lv_value ).
    ELSE.
      ep_title = me->title.
    ENDIF.
  ENDMETHOD.
...
*--------------------------------------------------------------------*
      ...
      lv_repeat_range_sheetname = zcl_excel_common=>zif_excel_common~escape_string( lv_repeat_range_sheetname ).
      ...
      ELSE.
        ...
        CASE lv_value_type.
          WHEN cl_abap_typedescr=>typekind_int OR cl_abap_typedescr=>typekind_int1 OR cl_abap_typedescr=>typekind_int2.
            ...
            IF sy-subrc = 0.
              <fs_numeric> = <fs_value>.
              lv_value = zcl_excel_common=>zif_excel_common~number_to_excel_string( ip_value = <fs_numeric> ).
            ENDIF.
          ...
          WHEN cl_abap_typedescr=>typekind_date.
            ...
            IF sy-subrc = 0.
              <fs_date> = <fs_value>.
              lv_value = zcl_excel_common=>zif_excel_common~date_to_excel_string( ip_value = <fs_date> ) .
            ENDIF.
* Begin of change issue #152 - don't touch exisiting style if only value is passed
...
* End of change issue #152 - don't touch exisiting style if only value is passed
          ...
          WHEN cl_abap_typedescr=>typekind_time.
            ...
            IF sy-subrc = 0.
              <fs_time> = <fs_value>.
              lv_value = zcl_excel_common=>zif_excel_common~time_to_excel_string( ip_value = <fs_time> ).
            ENDIF.
* Begin of change issue #152 - don't touch exisiting style if only value is passed
...
*    SHIFT lv_row_alpha LEFT DELETING LEADING space.  "del #152 - replaced with condense - should be faster
      ...
      lv_col_alpha = zcl_excel_common=>zif_excel_common~convert_column2alpha( ip_column ).       " issue #155 - less restrictive typing for ip_column
...
*--------------------------------------------------------------------*
    ...
    ls_merge-col_from = zcl_excel_common=>zif_excel_common~convert_column2int( ip_column_start ).
    ...
    ELSE.
      ls_merge-col_to   = zcl_excel_common=>zif_excel_common~convert_column2int( ip_column_end ).
    ENDIF.
...
* if a fix size is supplied use this
    TRY.
        ...
        ENDIF.
        lo_row->zif_excel_row~set_row_height( height ).
        EXIT.
      CATCH cx_sy_conversion_no_number.
* Strange stuff passed --> raise error
        RAISE EXCEPTION TYPE zcx_excel
  ...
  METHOD set_table.
    ...
    lv_column_int = zcl_excel_common=>zif_excel_common~convert_column2int( ip_top_left_column ).
...
* update dimension range
    ...
    lv_column_alpha = zcl_excel_common=>zif_excel_common~convert_column2alpha( upper_cell-cell_column ).
    ...
    lv_column_alpha = zcl_excel_common=>zif_excel_common~convert_column2alpha( lower_cell-cell_column ).
    SHIFT lv_row_alpha RIGHT DELETING TRAILING space.
    SHIFT lv_row_alpha LEFT DELETING LEADING space.
...
*--------------------------------------------------------------------*
    ...
    lv_col_from_int = zcl_excel_common=>zif_excel_common~convert_column2int( iv_columns_from ).
    lv_col_to_int   = zcl_excel_common=>zif_excel_common~convert_column2int( iv_columns_to ).
