...
*"* do not include other source files here!!!
  PRIVATE SECTION.
    ...
    CLASS-DATA eol TYPE abap_cr_lf VALUE cl_abap_char_utilities=>cr_lf. "#EC NOTEXT .  .  .  .  .  .  .  .  . " .
...
*        lc_value = zcl_excel_common=>excel_number_to_string( ip_value = <fs_sheet_content>-cell_value ).
        ...
        WHEN 'd' OR 'D'.
          lc_value = zcl_excel_common=>zif_excel_common~excel_string_to_date( ip_value = <fs_sheet_content>-cell_value ).
          TRY.
              lv_date = lc_value.
        ...
        WHEN 't' OR 'T'.
          lc_value = zcl_excel_common=>zif_excel_common~excel_string_to_time( ip_value = <fs_sheet_content>-cell_value ).
